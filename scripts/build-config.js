...
const bucket = process.env.SUPABASE_BUCKET || process.env.VITE_SUPABASE_BUCKET || 'concrem-fxcp-arquivos';

if (!url || !key) {
  console.error('ERRO: SUPABASE_URL e SUPABASE_KEY sao obrigatorios.');
  process.exit(1);
}
